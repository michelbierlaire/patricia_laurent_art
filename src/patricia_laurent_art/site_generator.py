...
class SiteGenerator:
    def __init__(self, manager: ContentManager | None = None, docs_dir: Path | None = None) -> None:
    ...
    def generate(self, *, base_url: str | None = None, theme: str | None = None) -> Path:
        ...
        for lang in SUPPORTED_LANGS:
            ...
            artwork_folder = self.docs_dir / lang / ('oeuvres' if lang == 'fr' else 'artworks')
            for view in views:
    ...
    def _make_artwork_views(self, artworks: list[Artwork], lang: str, base_url: str) -> list[ArtworkView]:
